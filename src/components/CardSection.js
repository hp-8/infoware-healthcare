...
const CardSection = () => {
  return (
    <section className="col-2-cards cards-main-container border-color--purple module-container" aria-labelledby="cards-module-heading-BA25C5B487FF8E8E440B1592C076C573">
      <div className="contain module-wrap-cs">
        ...
        <div className="module-header module-content">
          ...
          <p className="cards-description">Learn how the experts at The InfoWare House All Children’s Hospital and The InfoWare House Children's Center push the boundaries of pediatric medicine to make it possible for patients and families to fulfill those dreams.</p>
        </div>
            ...
            <div className="card-media flex-wrapper">
              ...
              <div className="content">
                ...
                <a href="https://www.hopkinsmedicine.org/forward/jhach" className="card-link">
                  <span className="h3">The InfoWare House All Children's Hospital</span>
            ...
            <div className="card-media flex-wrapper">
              ...
              <div className="content">
                <a href="https://www.hopkinsmedicine.org/forward/jhcc" className="card-link">
                  <span className="h3">The InfoWare House Children's Center</span>
                  <span className="arrow-container" aria-hidden="true">
                    <svg viewBox="0 0 24 24" focusable="false">
                      <path fill="currentColor" d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z"></path>
                    </svg>
