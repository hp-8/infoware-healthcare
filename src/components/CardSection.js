...
const CardSection = () => {
  return (
    <section className="cards-main-container border-color--purple module-container" aria-labelledby="cards-module-heading-BA25C5B487FF8E8E440B1592C076C573">
      <div className="contain module-wrap">
        ...
        <ul className="cards-container">
          <li className="card col-2-item card-has-image">
